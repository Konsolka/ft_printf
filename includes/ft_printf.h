...
/*   Updated: 2019/12/04 16:34:00 by abenton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_putnbr_maxint_u(uintmax_t nb, char *str, uintmax_t str_len,
				t_flags *flags);
int				ft_pad_nb(t_flags *flags, va_list args, char *base,
				char *hash_key);
